...
<html lang="en">
  <head>
   <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>School  Management|||Quản lí lớp học</title>
    <!-- plugins:css -->
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                      <h4 class="card-title mb-sm-0">Quản lí lớp học</h4>
                      <a href="#" class="text-dark ml-auto mb-3 mb-sm-0"> Xem tất cả lớp học</a>
                    </div>
                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th class="font-weight-bold">Khối ban</th>
                            <th class="font-weight-bold">Ngày đăng ký</th>
