...
<html lang="en">
  <head>
   <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>School  Management|||Tra cứu</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
             <div class="page-header">
              <h3 class="page-title"> Tra cứu học sinh </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Trang chủ</a></li>
                  <li class="breadcrumb-item active" aria-current="page"> Tra cứu học sinh</li>
                </ol>
              </nav>
            </div>
            <div class="row">
                  ...
                  <div class="card-body">
                    <form method="post">
                                <div class="form-group">
                                   <strong>Tra cứu học sinh:</strong>
                                   
                                    <input id="searchdata" type="text" name="searchdata" required="true" class="form-control" placeholder="Nhập mã học sinh"></div>
                               
                                <button type="submit" class="btn btn-primary" name="search" id="submit">Tra cứu</button>
                            </form>
                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th class="font-weight-bold">Mã số học sinh</th>
                            <th class="font-weight-bold">Lớp</th>
                            <th class="font-weight-bold">Họ và tên</th>
                            <th class="font-weight-bold">Email</th>
                            <th class="font-weight-bold">Ngày đăng ký nhập học</th>
                          ...
                          <tr>
                            ...
                            <td>
                              <div><a href="edit-student-detail.php?editid=<?php echo htmlentities ($row->sid);?>"><i class="icon-eye"></i></a>
                                                || <a href="manage-students.php?delid=<?php echo ($row->sid);?>" onclick="return confirm('Bạn có muốn xoá?');"> <i class="icon-trash"></i></a></div>
                            </td> 
                          </tr><?php 
$cnt=$cnt+1;
} } else { ?>
