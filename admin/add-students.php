...
<html lang="en">
  <head>
   ...
   <meta charset="UTF-8">
    <title>School  Management|| Đăng ký học sinh</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Đăng ký học sinh </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Trang chủ</a></li>
                  <li class="breadcrumb-item active" aria-current="page"> Đăng ký học sinh</li>
                </ol>
              </nav>
            </div>
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Đang ký học sinh</h4>
...
<option value="<?php echo htmlentities($row1->ID);?>"><?php echo htmlentities($row1->ClassName);?> <?php echo htmlentities($row1->Section);?></option>
 <?php } ?> 
                      ...
                      <h3>Thông tin phụ huynh học sinh</h3>
                      <div class="form-group">
...
<h3>Login details</h3>
<div class="form-group">
                        <label for="exampleInputName1">Số điện thoại cha/mẹ</label>
                      ...
                      <button type="submit" class="btn btn-primary mr-2" name="submit">Đăng ký/button>
