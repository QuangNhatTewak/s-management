...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>School  Management|| Báo cáo</title>
    <!-- plugins:css -->
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Báo cáo</h4>
                    ...
                    <form class="forms-sample" method="post" action="between-date-reprtsdetails.php">
                     ...
                     <div class="form-group">
                      ...
                      <button type="submit" class="btn btn-primary mr-2" name="submit">Tra cứu</button>
