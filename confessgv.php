...
<div class="container py-5">
    ...
    <div class="row text-center text-white mb-5">
        <div class="col-lg-8 mx-auto">
            ...
            <h1 class="display-4"><img src="/images/logo viền tròn (1).png" height="50" width="50" w> DAS Confession</h1>
            <p class="lead mb-0">Tâm tư của cậu ngày hôm nay. </p>
            <p class="lead"><a href="/addgv/index.php" class="text-white">
                <u>Tải bài viết</u></a></p>
            <p class="lead"><a href="https://studentmanagement.online/admin/dashboard.php" class="text-white">
                <u>Quay lại</u></a></p>
            </div>
        </div><!-- End -->
